...
// TMDB den gelen data icinde image linki bulunur. bu linki foto seklinde kullanabilmek icin de asagidaki img_api linkini kullaniriz. bu link sonuna ekleme yaparak kullanacagiz
...
const MovieCard = ({id, title, poster_path, overview, vote_average}) => {
    // context üretmek icin createContext, kullanmak icin useContext
