...
const Register = () => {
  ...
  const handleSubmit = () => {
    createUser(userData.email, userData.password, navigate, displayName);
...
// Note: Inputlari da button olarak kullanabiliriz onclick verebiliriz. Bunun icin, input type button olmasi gerekir. ancak söyle bir problem var. input alanlarimizi requiered yapmak istiyorsak bu durumda bu calismaz. bu nedenle böyle durumlarda formun onSubmit özelligi kullanilir. bunun sebebi onclick de form submit edilmez